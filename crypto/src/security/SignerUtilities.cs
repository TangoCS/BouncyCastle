...
namespace Org.BouncyCastle.Security
{
    ...
    public sealed class SignerUtilities
    {
        ...
        static SignerUtilities()
        {
            ...
            oids["GOST3411-2012-256"] = RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256;
            oids["GOST3411-2012-512"] = RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512;
            oids["GOST3411-2012-256WITHECGOST3410"] = RosstandartObjectIdentifiers.id_tc26_signwithdigest_gost_3410_12_256;
            oids["GOST3411-2012-512WITHECGOST3410"] = RosstandartObjectIdentifiers.id_tc26_signwithdigest_gost_3410_12_512;
            ...
            string algorithm)
        {
            ...
            if (mechanism.Equals("GOST3411-2012-256") || mechanism.Equals("GOST3411-2012-256WITHECGOST3410"))
            {
                return new Gost3410DigestSigner(new ECGost3410Signer(), new GOST3411_2012_256Digest());
            }
            if (mechanism.Equals("GOST3411-2012-512") || mechanism.Equals("GOST3411-2012-512WITHECGOST3410"))
            {
